...
--5. Вывести только e-mail пользователей
select email from students;
--6. Вывести имя и e-mail пользователей
...
select * from students where name like '%a%' order by name asc;
--13. Вывести пользователей, которые были созданы 2021-07-12 00:00:00
select * from students where created_on= '2021-07-12 00:00:00';
--14. Вывести пользователей, которые были созданы 2021-07012 00:00:00 и имеют пароль 1m313
...
--21. Вывести пользователей, у которых id меньше 127 или больше 180
